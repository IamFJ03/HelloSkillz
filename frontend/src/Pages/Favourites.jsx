  ...
  return (
    <div>
      ...
      <div className={` fixed inset-0 transition-all duration-500 ${modal ? 'bg-black/50 opacity-100 pointer-events-auto' : 'bg-transparent opacity-0 pointer-events-none'}`}>
        <div className={`relative md:h-70 h-80 md:w-120 w-100 bg-white shadow-lg rounded-2xl md:left-120 left-12 mt-50 ${modal ? 'scale-100' : 'scale-0'} transition-transform duration-500`} >
          ...
          <button className='px-5 py-1 cursor-pointer bg-blue-200 rounded mx-17 hover:scale-105 hover:shadow-md transition-all duration-500' onClick={() => setModal(false)}>Cancel</button>
